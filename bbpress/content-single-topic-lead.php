...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
	...
	<li class="bbp-header">
		...
		<div class="bbp-topic-author"><?php esc_html_e( 'Creator',  'metafans' ); ?></div><!-- .bbp-topic-author -->

		<div class="bbp-topic-content">

			<?php esc_html_e( 'Topic', 'metafans' ); ?>
	...
	<li class="bbp-footer">
		...
		<div class="bbp-topic-author"><?php esc_html_e( 'Creator',  'metafans' ); ?></div>

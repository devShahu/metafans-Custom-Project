...
add_action('admin_enqueue_scripts', function() {
    wp_enqueue_script('bp-demo-import', get_template_directory_uri() . '/inc/admin/demo-import.js', ['jquery'], null, true);
    ...
    wp_enqueue_style('bp-demo-import-style', get_template_directory_uri() . '/inc/admin/demo-import.css');
});

// 2. Add Admin Page with Import Button + Modal Container
add_action('admin_menu', function () {
    add_menu_page('Metafans Demo Import', 'METAFANS Demo Import', 'manage_options', 'bp-demo-import', 'bp_demo_import_page');
});

function bp_demo_import_page() {
    echo '<div class="wrap">
        <h1>Import METAFANS Demo</h1>
        <button id="start-demo-import" class="button button-primary">Import Metafans Demo</button>
    </div>';
...
function bp_demo_import_activities() {
    $file_path = get_template_directory() . '/demo-data/buddypress_demo_activities.json';
...
function bp_demo_import_users() {
    $file_path = get_template_directory() . '/demo-data/buddypress_demo_users.json';
...
function bp_demo_install_plugins() {
    ...
    // Install metafans-core from GitHub
    $core_plugin_url = 'https://github.com/tophive/metafans-core/releases/download/v1.2.0/metafans-core.zip';
    $upgrader = new Plugin_Upgrader(new BP_Silent_Upgrader_Skin());
    $result = $upgrader->install($core_plugin_url);

    if ($result && is_dir(WP_PLUGIN_DIR . '/metafans-core')) {
        $core_file = get_main_plugin_file('metafans-core');
...
function bp_demo_import_menus() {
	$menus_path = get_template_directory() . '/demo-data/buddypress_demo_menus.json';
...
function bp_demo_import_pages() {
    $file_path = get_template_directory() . '/demo-data/pages.json';
...
function bp_demo_import_forums() {
    $file = get_template_directory() . '/demo-data/forums.json';
...
function bp_demo_import_widgets_from_wie() {
    $file = get_template_directory() . '/demo-data/widgets.wie';
...
function bp_demo_import_block_widgets() {
    $file = get_template_directory() . '/demo-data/widget_block.txt';
...
function bp_demo_import_blog_posts() {
    $file = get_template_directory() . '/demo-data/blog_posts.json';
    if (!file_exists($file)) {
...
function bp_demo_import_groups() {
    ...
    $file = get_template_directory() . '/demo-data/buddypress_groups.json';
    if (!file_exists($file)) {
...
function bp_demo_import_customizer() {
    $file = get_template_directory() . '/demo-data/customizer_metafans.dat';
    if (!file_exists($file)) return;
    ...
    // Upload and set logo
    $logo_url = 'https://demo.tophivetheme.com/metafans/classic/wp-content/uploads/sites/10/2022/07/logo-300x58.png';

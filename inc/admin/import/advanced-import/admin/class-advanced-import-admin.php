...
class Advanced_Import_Admin {
	...
	public function enqueue_styles( $hook_suffix ) {
		...
		wp_enqueue_style( $this->plugin_name, ADVANCED_IMPORT_URL . '/inc/admin/import/advanced-import/assets/css/advanced-import-admin' . ADVANCED_IMPORT_SCRIPT_PREFIX . '.css', array( 'wp-admin', 'dashicons' ), $this->version, 'all' );
		wp_enqueue_media();
	}
	...
	public function enqueue_scripts( $hook_suffix ) {
		...
		wp_enqueue_script(
			'isotope', // Handle.
			ADVANCED_IMPORT_URL . '/inc/admin/import/advanced-import//assets/library/isotope/isotope.pkgd' . ADVANCED_IMPORT_SCRIPT_PREFIX . '.js',
		...
		wp_enqueue_script(
			'sweetalert2', // Handle.
			ADVANCED_IMPORT_URL . '/inc/admin/import/advanced-import//assets/library/sweetalert2/sweetalert2.all' . ADVANCED_IMPORT_SCRIPT_PREFIX . '.js',
			array( 'jquery' ), // Dependencies, defined above.
			'3.0.6', // Version: File modification time.
			true // Enqueue the script in the footer.
		);

		wp_enqueue_script( $this->plugin_name, ADVANCED_IMPORT_URL . '/inc/admin/import/advanced-import/assets/js/advanced-import-admin' . ADVANCED_IMPORT_SCRIPT_PREFIX . '.js', array( 'jquery', 'masonry' ), $this->version, true );
		wp_localize_script(
			$this->plugin_name,

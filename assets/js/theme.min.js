...
jQuery(document).ready(function ($) {
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data.loggedin) {
          ...
          form
            .find(".login-notices")
            .removeClass("ec-text-danger")
            .addClass("ec-text-success")
            .html(data.message);
          form.find("button").removeClass("loading");
        } else {
          form
            .find(".login-notices")
            .addClass("ec-text-danger")
            .html(data.message);
          form.find("button").removeClass("loading");
        }
      },
  ...
  $(document).on("click", ".switch-register", function (e) {
    ...
    $(".signup-segment")
      .fadeIn()
      .removeClass("ec-d-none")
      .addClass("ec-d-block");
    $(".login-segment")
      .fadeOut()
      .removeClass("ec-d-block")
      .addClass("ec-d-none");
    $(".recover-segment")
      .fadeOut()
      .removeClass("ec-d-block")
  ...
  if (sidebar.length > 0) {
    ...
    jQuery(window).scroll(function (event) {
      ...
      if (dragBottomDown) {
        ...
        var isPageAtBottom =
          scrollTop + windowHeight >= jQuery(document).height();
  ...
  if (sidebar2.length > 0) {
    ...
    jQuery(window).scroll(function (event) {
      ...
      if (
        (isWindowLarger2 && scrollTop2 > initialSidebarTop2) ||
        (!isWindowLarger2 && scrollTop2 > initialSidebarTop2 + heightDelta2)
      ) {
      ...
      if (dragBottomDown2) {
        ...
        var isPageAtBottom2 =
          scrollTop2 + windowHeight2 >= jQuery(document).height();
